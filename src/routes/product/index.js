...
router.get(
    "/search/:keySearch",
    asyncHanlder(ProductController.getListSearchProduct)
);
...
router.post(
    "/published/:id",
    asyncHanlder(ProductController.publishProductByShop)
);
router.post(
    "/unpublished/:id",
    asyncHanlder(ProductController.unpublishProductByShop)
);
router.patch("/:productId", asyncHanlder(ProductController.updateProduct));
//Query
router.get("/drafts/all", asyncHanlder(ProductController.getAllDraftsForShop));
router.get(
    "/published/all",
    asyncHanlder(ProductController.getAllPublishedForShop)
);
